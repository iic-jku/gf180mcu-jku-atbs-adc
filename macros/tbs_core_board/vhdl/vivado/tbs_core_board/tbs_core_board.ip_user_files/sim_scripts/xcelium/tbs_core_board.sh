...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../tbs_core_board.gen/sources_1/ip/pll_8MHz" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../tbs_core_board.gen/sources_1/ip/pll_8MHz" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.tbs_core_board xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.tbs_core_board -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log tbs_core_board_sc.so .tmp_log xcelium_lib waves.shm c.obj)
