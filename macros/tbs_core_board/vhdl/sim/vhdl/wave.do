...
add wave -noupdate /tbs_core_tb/dut_tbs/CLK_FREQ
add wave -noupdate /tbs_core_tb/dut_tbs/MAIN_COUNTER_BITWIDTH
add wave -noupdate /tbs_core_tb/dut_tbs/MAIN_COUNTER_MAX
add wave -noupdate /tbs_core_tb/dut_tbs/DEBOUNCER_BITWIDTH
add wave -noupdate /tbs_core_tb/dut_tbs/DEBOUNCER_MAX
add wave -noupdate /tbs_core_tb/dut_tbs/N_FF
add wave -noupdate /tbs_core_tb/dut_tbs/N_CHANNELS
add wave -noupdate /tbs_core_tb/dut_tbs/MAX_CLIPPING_VALUE
add wave -noupdate /tbs_core_tb/dut_tbs/MIN_CLIPPING_VALUE
add wave -noupdate /tbs_core_tb/dut_tbs/D_MAX_LIM
add wave -noupdate /tbs_core_tb/dut_tbs/D_MIN_LIM
add wave -noupdate /tbs_core_tb/dut_tbs/WEYLSD_BITS
add wave -noupdate /tbs_core_tb/dut_tbs/DELTA_STEPS_BITWIDTH
add wave -noupdate /tbs_core_tb/dut_tbs/TIME_COUNTER_BITWIDTH
add wave -noupdate /tbs_core_tb/dut_tbs/TIME_COUNTER_MAX
add wave -noupdate /tbs_core_tb/dut_tbs/DAC_SETTLING_CLKS
add wave -noupdate /tbs_core_tb/dut_tbs/DAC_BITWIDTH
add wave -noupdate /tbs_core_tb/dut_tbs/TRIGGER_COUNTER_BITWIDTH
add wave -noupdate /tbs_core_tb/dut_tbs/TRIGGER_COUNTER_MAX
add wave -noupdate /tbs_core_tb/dut_tbs/SC_NOC_COUNTER_BITWIDTH
add wave -noupdate /tbs_core_tb/dut_tbs/SC_NOC_COUNTER_MAX
add wave -noupdate /tbs_core_tb/dut_tbs/ADDR_BITWIDTH
add wave -noupdate /tbs_core_tb/dut_tbs/DATA_BITWIDTH
add wave -noupdate /tbs_core_tb/dut_tbs/UART_BAUD_COUNTER_BITWIDTH
add wave -noupdate /tbs_core_tb/dut_tbs/UART_BAUD_COUNTER_MAX
add wave -noupdate /tbs_core_tb/dut_tbs/UART_DATA_LENGTH
add wave -noupdate -divider INPUTS
add wave -noupdate /tbs_core_tb/dut_tbs/clock_i
add wave -noupdate /tbs_core_tb/dut_tbs/reset_btn_i
...
add wave -noupdate -radix unsigned /tbs_core_tb/dut_tbs/main_counter_value
add wave -noupdate /tbs_core_tb/dut_tbs/reset_main_counter_strb
add wave -noupdate -divider {MAIN FSM}
add wave -noupdate /tbs_core_tb/dut_tbs/dac_control_0/state
add wave -noupdate /tbs_core_tb/dut_tbs/state
add wave -noupdate /tbs_core_tb/dut_tbs/detection_en
add wave -noupdate /tbs_core_tb/dut_tbs/select_enable_write
add wave -noupdate /tbs_core_tb/dut_tbs/clear_dac
add wave -noupdate /tbs_core_tb/dut_tbs/dac_init_strb
add wave -noupdate /tbs_core_tb/dut_tbs/enable_read
add wave -noupdate -divider {SIGNAL Path}
add wave -noupdate /tbs_core_tb/dut_tbs/spike_detector_0/spike
add wave -noupdate /tbs_core_tb/dut_tbs/spike_detector_0/spike_strb
add wave -noupdate /tbs_core_tb/dut_tbs/spike_detector_0/lock_detection
add wave -noupdate /tbs_core_tb/dut_tbs/update_dac_upper_strb
add wave -noupdate /tbs_core_tb/dut_tbs/dac_finished_upper_strb
add wave -noupdate /tbs_core_tb/dut_tbs/increasing_en
...
add wave -noupdate -radix unsigned /tbs_core_tb/dut_tbs/spike_memory_0/b_data_o
add wave -noupdate /tbs_core_tb/dut_tbs/spike_memory_0/read_strb_o
add wave -noupdate -radix unsigned /tbs_core_tb/dut_tbs/tx_data
add wave -noupdate -divider {UART/Switch Control}
add wave -noupdate -radix ascii /tbs_core_tb/dut_tbs/uart_rx_data
add wave -noupdate /tbs_core_tb/dut_tbs/uart_rx_data_strb
add wave -noupdate /tbs_core_tb/dut_tbs/analog_trigger_uart
add wave -noupdate -radix unsigned /tbs_core_tb/dut_tbs/analog_trigger_period_adj_uart
add wave -noupdate -radix unsigned /tbs_core_tb/dut_tbs/analog_trigger_duty_cycle_adj_uart
add wave -noupdate /tbs_core_tb/dut_tbs/sc_noc_generator_uart
add wave -noupdate -radix unsigned /tbs_core_tb/dut_tbs/sc_noc_generator_period_adj_uart
add wave -noupdate -radix unsigned /tbs_core_tb/dut_tbs/sc_noc_generator_duty_cycle_adj_uart
add wave -noupdate -radix unsigned /tbs_core_tb/dut_tbs/sc_noc_generator_overlap_adj_uart
add wave -noupdate /tbs_core_tb/dut_tbs/baudrate_uart
add wave -noupdate -radix unsigned /tbs_core_tb/dut_tbs/baudrate_adj_uart
add wave -noupdate /tbs_core_tb/dut_tbs/tbs_virtual_delta_steps_uart
add wave -noupdate -radix unsigned /tbs_core_tb/dut_tbs/tbs_virtual_delta_steps_adj_uart
add wave -noupdate -radix unsigned /tbs_core_tb/dut_tbs/tbs_delta_steps_upper
add wave -noupdate -radix unsigned /tbs_core_tb/dut_tbs/tbs_delta_steps_lower
add wave -noupdate /tbs_core_tb/dut_tbs/input_changed_strb
add wave -noupdate /tbs_core_tb/dut_tbs/input_changed_reset_strb
add wave -noupdate /tbs_core_tb/dut_tbs/uart_changed_strb
add wave -noupdate /tbs_core_tb/dut_tbs/uart_changed_reset_strb
...
add wave -noupdate /tbs_core_tb/dut_tbs/enable_analog
